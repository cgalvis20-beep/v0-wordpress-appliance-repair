...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: "MyappliancePro saved us from buying a new dishwasher. Other companies said it couldn't be fixed, but their technician found the problem and repaired it for a fraction of the replacement cost.",
    service: "Dishwasher Repair",
    date: "2024-03-28",
  },
  {
