...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    highlights: [
      "Maytag repair experts",
      "Built-to-last repairs",
      "Quality parts used",
