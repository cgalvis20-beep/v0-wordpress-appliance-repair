      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
            Get the fix you need with the protection you deserve. All work is backed by our 90-day parts and labour warranty, with new 6-month to 1-year extended warranty options available for premium repairs. Book your reliable, same-day appliance repair today!
          </p>
